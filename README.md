...
- **[Conditioning](https://valkymaera.github.io/ComfyCollectorNodes/nodes/conditioning/)** — edit prompts in embedding space: Token/Concept/Hyper Remap for blending words toward other meanings, Projection Removal as a negative-prompt substitute for flow models, plus scale/normalize/clamp/lerp/subtract and inspection tools.
